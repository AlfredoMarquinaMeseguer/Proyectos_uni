...
void backtracking(lista enteros candidatos, entero numCandidatos, lista enteros equipoA, lista enteros equipoB)
{
    si (EsVacía(candidatos) o (numCandidatos/2 - longitud(candidatos)) > (numCandidatos - longitud(equipoA))) // Esta última puede estar mal
        return;

    // Miramos al solución si añadimos candidato actual a la izquierda

    // Miramos al solución si añadimos candidato actual a la derecha

    // Si es mejor que la solución por la izquierda nos quedamos esa
